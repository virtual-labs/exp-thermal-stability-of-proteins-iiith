...
function initial_function() {
  ...
  document.getElementById("demo").innerHTML =
    "Step1: Prepare a 4.1 × 10<sup>-6</sup> M fluorescein solution in spectroscopy grade ethanol from a 8.2 × 10<sup>-4</sup> M fluorescein stock solution. Click on the volumetric flask containing the fluorescein solution to take it onto the instrument table.";
...
function addclickEvents() {
  ...
  document.getElementById("round-bottom-flask").addEventListener(
    "click",
    function () {
      moveFlask();
    },
  ...
  document.getElementById("spectrolid_trans_button1").addEventListener(
    "click",
    function () {
      spectrofluorimeter();
    },
  ...
  document.getElementById("ok_btn").addEventListener(
    "click",
    function () {
      okBtn();
    },
...
function removeClock() {
  ...
  document.getElementById("demo").innerHTML =
    "Step-No 8: Click on the lid of sample chamber of the spectrofluorimeter to open it for placing the sample in the instrument";
...
function spectrofluorimeter() {
  if (step_no == 7) {
    ...
    document.getElementById("demo").innerHTML =
      "Step-No 9: Click on the cuvette to place it in the sample holder of the chamber.";
    ...
    images[1] = "../../common_images/specfluor_on_no_redLight.png";
    document.getElementById("demo").innerHTML =
      "Step-No 11: Click on the Computer Screen!";
...
function selectGraph() {
  ...
  dropdown.onchange = function (event) {
    ...
    if (dropdown.value == "Emission" && step_no == 11) {
      $("#select").html(
        "<option value='Excitation'>Excitation</option><option value='Emission'>Emission</option>"
      );
      alert("Select Excitation scan mode");
    } else if (dropdown.value == "Excitation" && step_no == 14) {
      $("#select").html(
        "<option value='Emission'>Emission</option><option value='Excitation'>Excitation</option>"
      );
...
function okBtn() {
  ...
  if (input1 == 515 && input2 == 300 && input3 == 600 && step_no == 11) {
    ...
    document.getElementById("demo").innerHTML =
      "Step-No 13:Click on the close button when the spectral scal is complete. In real operation, the scan data are stored in the computer. The instrument stores data and therefore asks for the Sample File name. One enters a file name to save the data.";
    video1.play();
    step_no++;
...
function disposeGraph() {
  ...
  if (step_no == 12) {
    ...
    document.getElementById("demo").innerHTML =
      "Step-No 14:To run the Emission Spectral Scan of the sample, open the instrument set-up screen by clicking on the fluorescence measurement icon on the computer monitor.Select the Emission Scan Mode on the screen.";
